...
from typing import Optional, Iterable, Optional, List, Self, Literal, Dict, Tuple, Any, Union
...
class BaseNNSplitter(BaseSplitter):
    ...
    def fit(self, compounds: Iterable[Compound]) -> Self:
        ...
        all_triplets = []
        all_link_ids = []
        progress_bar = tqdm(compounds, desc="Preprocessing train") if self.verbose else compounds
        ...
        train_dataloader = DataLoader(
            ...
            XYDataset(all_triplets, all_link_ids),
