"""
Tools for Llama3.1-based pipelines for splitting German compounds. English version.
"""
...
def get_paradigm_english(lemma: str) -> str:
	...
	"""
	Get a textual description of the paradigm of a German noun from Wiktionary. 
	...
	it is also returned as a string hint (e.g. "The nominative word {lemma} wasn't found
